...
class Condensor {
  ...
  */
  ...
  static bool handleBackwardCorrispondingSequences(CompileSet* i_compileSet,
  ...
  static PinStateSequenceVector::iterator prepareSequences(CompileSet* i_compileSet);
