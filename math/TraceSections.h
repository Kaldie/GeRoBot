...
#ifndef MATH_TRACESECTIONS_H_
#define MATH_TRACESECTIONS_H_
...
namespace TraceSections {
  ...
  /**
   * Given TraceSections get the nearest one near the given point
  ...
  TraceSections getInsideSections(const TraceSections& i_sections,
                                  const TraceSection& i_biggerSection);
  /**
